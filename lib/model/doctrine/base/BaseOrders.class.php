 ...
 * @property string $order_sessions_id
 ...
 * @method string        getOrderSessionsId()   Returns the current record's "order_sessions_id" value
...
abstract class BaseOrders extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('order_sessions_id', 'string', 225, array(
             'type' => 'string',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
